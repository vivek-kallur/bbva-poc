 ...
 * specified {@link com.bbvacompass.PlaceFragment.OnListItemClickListener}.
...
public class PlacesRecyclerViewAdapter extends RecyclerView.Adapter<PlacesRecyclerViewAdapter.ViewHolder> {
    ...
    private final PlaceFragment.OnListItemClickListener mListener;

    public PlacesRecyclerViewAdapter(List<Place> items, PlaceFragment.OnListItemClickListener listener) {
        mValues = items;
        mListener = listener;
    }
